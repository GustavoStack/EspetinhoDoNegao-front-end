    ...
    <section id="início" className="relative h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl sm:text-2xl text-white font-light mb-8 max-w-2xl mx-auto">
            Tradição e sabor em cada espeto. Os melhores epetinhos da região.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#menu" onClick={(e) => {e.preventDefault();scrollToSection("menu")}}  className="btn-primary flex items-center justify-center gap-2">
      ...
      <div className="absolute bottom-10 left-0 right-0 z-10">
        <div className="flex justify-center">
          <a href="#sobre" onClick={(e) => {e.preventDefault();scrollToSection("sobre")}}  className="animate-bounce text-white">
